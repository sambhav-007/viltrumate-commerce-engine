...
// bundle a deployment package for download. Matches the repo's dependency-free
// ethos (cf. the CSV import parser). Not a general-purpose archiver.
const CRC_TABLE = (() => {
...
// entries: [{ name, content }] (content: string or Buffer). Returns a Buffer.
